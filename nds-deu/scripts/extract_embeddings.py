...
def main():
    ...
    ap.add_argument("--glossary", required=True, help="glossario WIDE held-out (de_word, nds_var1..k)")
    ...
    if not forms:
        raise SystemExit("Nessuna forma nel glossario: controlla il file / le colonne nds_var*.")
